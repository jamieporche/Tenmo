...
public class Transfer {
    ...
    public Transfer(@Positive(message = "Transfer amount must be greater than zero.") BigDecimal transferAmount, int transferType, int transferStatus, int payeeAccount, int payerAccount) {
